...
update_feeds() {
    ...
    sed -i '/luci_app_quickstart/d' "$FEEDS_PATH"
    ...
    # iStore 应用商店源（linkease）
    append_feed_if_missing "$FEEDS_PATH" "istore" "src-git istore https://github.com/linkease/istore;main"
